...
const FryingPanLoading: React.FC<{ className?: string }> = ({ className = '' }) => (
  <div className={`flex items-center justify-center ${className}`}>
    <svg 
      className="frying-pan-loader" 
      viewBox="0 0 128 128" 
      width="96px" 
      height="96px" 
      role="img" 
    ...
    <style jsx>{`
      ...
      @media (prefers-color-scheme: dark) {
        .frying-pan-loader {
          color: hsl(210, 1.6666666666666667%, 23.52941176470588%);
        }
      }
...
export default FryingPanLoading;
